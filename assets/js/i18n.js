...
(function () {
  var T = {
    en: {
      ...
      'hero.coming_soon': 'Coming soon to',
      'hero.play_store':  'Google Play',
      /* ── Features ── */
      ...
      'privacy.hero.sub':   'Last updated: May 16, 2026',
      'privacy.intro': 'MinMen Studio ("we", "us", or "our") operates the DragonFish mobile application (the "App") on iOS and Android. This Privacy Policy explains what information is collected when you use the App, how it is used, and your choices regarding that information.',
      'privacy.h1':   '1. Information We Collect',
      'privacy.1.p1': 'DragonFish is designed to work offline for core gameplay. Game data — moves, positions, history, hearts balance, and settings — is stored <strong>locally on your device only</strong> (iOS UserDefaults / Android SharedPreferences). It is never transmitted to our servers.',
      'privacy.1.p2': 'On the Android version, the App uses the following Google services for app health, abuse prevention, and ad delivery. No personally identifiable information (name, email, exact location) is collected.',
      'privacy.1.li1': '<strong>Firebase Analytics</strong> — anonymous usage events such as app launches and out-of-hearts paywall hits. Events are tagged only with an automatically-generated app instance ID.',
      'privacy.1.li2': '<strong>Firebase Crashlytics</strong> — crash reports and stack traces sent when the App crashes, to help us diagnose and fix bugs.',
      'privacy.1.li3': '<strong>Cloud Firestore</strong> — stores a one-way SHA-256 hash of the device\'s Android App Set ID to detect when the same device reinstalls the App. This prevents abuse of the free starter hearts. The hash cannot be reversed to identify your device or you personally.',
      'privacy.h2':   '2. In-App Purchases',
      'privacy.2.p':  'DragonFish offers optional in-app purchases (heart packages and engine unlock). On iOS, purchases are processed by Apple\'s App Store. On Android, purchases are processed by Google Play Billing. We do not receive or store any payment or financial information. See <a href="https://www.apple.com/legal/privacy/" target="_blank" rel="noopener noreferrer">Apple\'s Privacy Policy</a> and <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Google\'s Privacy Policy</a> for details on how each platform handles purchase data.',
      'privacy.h3':   '3. Advertising',
      'privacy.3.p':  'On the Android version, the App may display rewarded video ads via <a href="https://support.google.com/admob/answer/6128543" target="_blank" rel="noopener noreferrer">Google AdMob</a> if you choose to watch them in exchange for in-game rewards (extra hearts). AdMob may collect and use the device\'s Advertising ID for ad serving and measurement. You can reset or limit ad personalization in your device Settings → Privacy → Ads. The iOS version does not currently display ads.',
      ...
      'privacy.5.p':  'Local device data is deleted when you uninstall the App. Firebase Analytics events are retained for the period configured by Google (default 14 months) before being aggregated. Crash reports are retained for 90 days. Anti-abuse install records (the hashed App Set ID described in Section 1) are retained for as long as they remain useful for abuse-prevention purposes. You may request deletion of data tied to your device at any time — see Section 7.',
      'privacy.h6':   '6. Security',
      'privacy.6.p':  "All data transmitted between the App and our cloud providers is encrypted in transit (HTTPS / TLS). Local data on your device is protected by your device's own security mechanisms (Face ID, fingerprint, passcode).",
      'privacy.h7':   '7. Your Rights & Data Deletion',
      'privacy.7.p':  "You have the right to request access to, correction of, or deletion of data we hold that is associated with your device. To make such a request, email us at the address in Section 9 with a description of your request. We will respond within 30 days. Most data we collect is anonymous and not tied to a personally-identifying account, so we may need additional information (for example, your device's anonymous Firebase app instance ID) to locate and delete the relevant records.",
      'privacy.h8':   '8. Changes to This Policy',
      'privacy.8.p':  'We may update this Privacy Policy from time to time. Changes will be posted on this page with an updated revision date. Continued use of the App after any changes constitutes acceptance of the updated policy.',
      'privacy.h9':   '9. Contact Us',
      'privacy.9.p1': 'If you have any questions or concerns about this Privacy Policy, or to make a data request, please contact us at:',
      'privacy.9.p2': '<strong>MinMen Studio</strong><br />Email: <a href="mailto:dragonfish.minmenstudio@gmail.com">dragonfish.minmenstudio@gmail.com</a>',
    },
    ...
    vi: {
      ...
      'privacy.hero.sub':   'Cập nhật lần cuối: 16 tháng 5, 2026',
      'privacy.intro': 'MinMen Studio ("chúng tôi") vận hành ứng dụng di động DragonFish ("Ứng dụng") trên iOS và Android. Chính sách quyền riêng tư này giải thích thông tin nào được thu thập khi bạn sử dụng ứng dụng, cách chúng tôi sử dụng và các lựa chọn của bạn liên quan đến thông tin đó.',
      'privacy.h1':   '1. Thông tin chúng tôi thu thập',
      'privacy.1.p1': 'DragonFish được thiết kế để hoạt động offline cho phần chơi cơ bản. Dữ liệu trò chơi — nước đi, thế cờ, lịch sử, số tim, cài đặt — chỉ được lưu <strong>cục bộ trên thiết bị của bạn</strong> (iOS UserDefaults / Android SharedPreferences). Không bao giờ được truyền lên máy chủ của chúng tôi.',
      'privacy.1.p2': 'Trên phiên bản Android, ứng dụng sử dụng các dịch vụ Google sau cho mục đích theo dõi tình trạng ứng dụng, ngăn lạm dụng và phân phối quảng cáo. Không thu thập thông tin nhận dạng cá nhân (tên, email, vị trí chính xác).',
      'privacy.1.li1': '<strong>Firebase Analytics</strong> — sự kiện sử dụng ẩn danh như lần mở ứng dụng và lần đụng paywall hết tim. Sự kiện chỉ gắn với một mã app instance được tạo tự động.',
      'privacy.1.li2': '<strong>Firebase Crashlytics</strong> — báo cáo crash và stack trace khi ứng dụng gặp sự cố, giúp chúng tôi chẩn đoán và sửa lỗi.',
      'privacy.1.li3': '<strong>Cloud Firestore</strong> — lưu một dạng hash SHA-256 (một chiều) của Android App Set ID trên thiết bị để phát hiện khi cùng một thiết bị cài lại ứng dụng. Mục đích là ngăn lạm dụng số tim khởi đầu miễn phí. Hash không thể đảo ngược để xác định thiết bị hay danh tính của bạn.',
      'privacy.h2':   '2. Mua hàng trong ứng dụng',
      'privacy.2.p':  'DragonFish cung cấp các gói mua trong ứng dụng (gói tim và mở khoá engine). Trên iOS, giao dịch được xử lý bởi App Store của Apple. Trên Android, giao dịch được xử lý bởi Google Play Billing. Chúng tôi không nhận hay lưu trữ bất kỳ thông tin thanh toán nào. Xem <a href="https://www.apple.com/legal/privacy/" target="_blank" rel="noopener noreferrer">Chính sách quyền riêng tư của Apple</a> và <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Chính sách quyền riêng tư của Google</a> để biết chi tiết cách mỗi nền tảng xử lý dữ liệu mua hàng.',
      'privacy.h3':   '3. Quảng cáo',
      'privacy.3.p':  'Trên phiên bản Android, ứng dụng có thể hiển thị quảng cáo video có thưởng qua <a href="https://support.google.com/admob/answer/6128543" target="_blank" rel="noopener noreferrer">Google AdMob</a> nếu bạn chọn xem để đổi lấy phần thưởng trong game (thêm tim). AdMob có thể thu thập và sử dụng Advertising ID của thiết bị để serve quảng cáo và đo lường. Bạn có thể reset hoặc giới hạn cá nhân hoá quảng cáo trong Cài đặt thiết bị → Quyền riêng tư → Quảng cáo. Phiên bản iOS hiện không hiển thị quảng cáo.',
      ...
      'privacy.5.p':  'Dữ liệu cục bộ trên thiết bị sẽ bị xoá khi bạn gỡ cài đặt ứng dụng. Sự kiện Firebase Analytics được lưu trong thời gian Google cấu hình (mặc định 14 tháng) rồi được tổng hợp. Báo cáo crash được lưu 90 ngày. Bản ghi chống lạm dụng cài lại (hash App Set ID nêu ở Mục 1) được lưu vô thời hạn miễn còn hữu ích cho mục đích chống lạm dụng. Bạn có thể yêu cầu xoá dữ liệu liên quan đến thiết bị bất cứ lúc nào — xem Mục 7.',
      'privacy.h6':   '6. Bảo mật',
      'privacy.6.p':  'Tất cả dữ liệu truyền giữa ứng dụng và các dịch vụ đám mây của chúng tôi đều được mã hoá khi truyền (HTTPS / TLS). Dữ liệu cục bộ trên thiết bị được bảo vệ bằng các cơ chế bảo mật của chính thiết bị (Face ID, vân tay, mã PIN).',
      'privacy.h7':   '7. Quyền của bạn & xoá dữ liệu',
      'privacy.7.p':  'Bạn có quyền yêu cầu truy cập, sửa đổi, hoặc xoá dữ liệu chúng tôi lưu liên quan đến thiết bị của bạn. Để gửi yêu cầu, email địa chỉ trong Mục 9 kèm mô tả yêu cầu. Chúng tôi sẽ phản hồi trong vòng 30 ngày. Phần lớn dữ liệu chúng tôi thu thập là ẩn danh và không gắn với tài khoản nhận dạng cá nhân, nên chúng tôi có thể cần thêm thông tin (ví dụ Firebase app instance ID ẩn danh của thiết bị) để tìm và xoá các bản ghi liên quan.',
      'privacy.h8':   '8. Thay đổi chính sách',
      'privacy.8.p':  'Chúng tôi có thể cập nhật chính sách này theo thời gian. Các thay đổi sẽ được đăng tại đây kèm ngày cập nhật. Việc tiếp tục sử dụng ứng dụng sau khi có thay đổi đồng nghĩa với việc bạn chấp nhận chính sách mới.',
      'privacy.h9':   '9. Liên hệ chúng tôi',
      'privacy.9.p1': 'Nếu bạn có câu hỏi hay thắc mắc về chính sách này, hoặc muốn yêu cầu về dữ liệu, vui lòng liên hệ:',
      'privacy.9.p2': '<strong>MinMen Studio</strong><br />Email: <a href="mailto:dragonfish.minmenstudio@gmail.com">dragonfish.minmenstudio@gmail.com</a>',
    }
  };
